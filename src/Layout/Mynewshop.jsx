              ...
              <CustomDropdown
                ...
                onChange={(e) => {
                  const selected = countryCodes.find(
                    (c) => `${c.flag} ${c.code} ${c.name}` === e.target.value
                  );
                  setForm((s) => ({
                    ...s,
                    countryCode: selected?.code || "+1",
                  }));
                }}
                name="countryCode"
                placeholder="+1"
          ...
          <div>
            ...
            <div className="flex mt-1 gap-2 items-center">
              <CustomDropdown
                ...
                value={
                  countryCodes.find((c) => c.code === form.whatsappCode)?.flag +
                    " " +
                    form.whatsappCode || "+1"
                }
                onChange={(e) => {
